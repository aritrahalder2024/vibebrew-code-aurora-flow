...
const FeatureCard = React.memo(({ icon, title, description }: {
  ...
  <div className="glass-strong rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:scale-105 transition-transform duration-300 group">
    ...
    <h3 className="text-xl sm:text-2xl font-space-grotesk font-bold text-white mb-3 sm:mb-4 text-center">{title}</h3>
      ...
      <div className="container mx-auto relative z-10 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          <FeatureCard
            ...
            description="Discover cutting-edge projects, share your innovations, and collaborate with fellow creators pushing boundaries."
          />
          ...
          <FeatureCard
            ...
            description="Connect with like-minded creators, find collaborators, and build meaningful relationships in our vibrant community."
          />
          ...
          <FeatureCard
            ...
            description="Learn from experienced creators, share knowledge, and accelerate your growth through community support."
          />
        </div>
      </div>
    </section>
