...
export const Navigation = () => {
  ...
  return (
    <nav className="fixed left-1/2 top-6 -translate-x-1/2 z-50 w-[96vw] max-w-6xl">
      <div className="navbar-glass h-16 sm:h-20 flex items-center rounded-full shadow-lg px-4 sm:px-8">
